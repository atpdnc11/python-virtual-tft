...
canvas.create_text(center_x, center_y, text=" by arvind patil ", font=("Arial", 10), fill="black")
...
# Create a text object on the canvas
canvas.create_text(center_x, center_y, text="अरविन्द पाटील ", font=("Arial", 16), fill="red")
